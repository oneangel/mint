...
export const TransactionHistory = ({ transactions, isLoading }) => {
  return (
    <div className=" shadow-md w-full dark:border-zinc-800bg-white rounded-3xl border-1 border-gray-200 h-[400px] bg-white dark:bg-zinc-900 dark:border-zinc-800 transition">
