    ...
    <div className="flex flex-col min-h-screen">
      <section className="flex-grow grid grid-cols-2 gap-0">
        ...
        <div className="bg-cyan-100/70 rounded-ss-[130px] rounded-es-[130px] py-28">
          <form className="max-w-xl mx-auto" onSubmit={onNextStep}>
            {/* Campos */}
            <div className="mb-12">
            ...
            <div className="mb-12">
              ...
              <p className="text-2xl font-light mt-3">
                Al continuar, confirma que está autorizado para utilizar este
                número de teléfono y acepta recibir mensajes de texto.
              </p>
            </div>
